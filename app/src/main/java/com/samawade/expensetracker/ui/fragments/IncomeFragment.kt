...
import com.samawade.expensetracker.databinding.FragmentIncomeBinding
...
class IncomeFragment : BaseFragment<UserViewModel, FragmentIncomeBinding, UserRepository>() {
...
//        }
    ...
    private fun updateUI(statement: Statement) {
        with(binding){
            textTotalIncome.text = "$"+statement.userincome
        }
    }
